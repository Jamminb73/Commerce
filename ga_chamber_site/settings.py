"""
Django settings for ga_chamber_site project.
...
SECRET_KEY = ''  # Filled locally by local_settings.py or via env variables on production

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False    # Fallback default for safety; local_settings.py will override this to True locally
...
ROOT_URLCONF = 'ga_chamber_site.urls'
...
WSGI_APPLICATION = 'ga_chamber_site.wsgi.application'
...
DATABASES = {
    'default': {}  # Filled locally by local_settings.py or via env variables on production
}
